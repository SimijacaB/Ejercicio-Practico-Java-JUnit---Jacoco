...
public class Example {
    ...
    //1. Método para sumar dos numeros
    public int sumar(int a, int b) {
        return a + b;
    }

    //2. Metodo que lanza excepcion si el argumento es negativo
    ...
    // 11. Método para convertir y unir una lista  a mayuscaula, a un string
    public String convertirYUnirEnMayusculas(List<String> lista) {
        return lista.stream()
